      ...
      {user && user.role === "manager" ? (
        <div className="manager__header">
          ...
          <div className="manager__navbar">
            <Link to="/manager/" className="manager__navbar-link">Каталог</Link>
            <Link to="/manager/orders" className="manager__navbar-link">Заказы</Link>
            <Link to="/manager/library" className="manager__navbar-link">Библиотека</Link>
            <select
              value={selected}
              onChange={handleUserNav}
              className="manager__navbar-select"
            >
              <option value="" disabled>Пользовательское</option>
          ...
          <div className="manager__header-account">
            {user ? (
              <span className="manager__header-username" onClick={() => navigate('/profile')}>
                {user.displayName}
              </span>
            ) : (
              <span className="manager__header-login-button" onClick={() => setShowLogin(true)}>
                Войти
              </span>
            )}
          </div>
        ...
        <div className="user__header">
          ...
          <div className="user__header-account">
            {user ? (
              ...
              <span className="user__header-login-button" onClick={() => setShowLogin(true)}>
                Войти
              </span>
            )}
          </div>
